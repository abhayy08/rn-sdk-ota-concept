...
const bundleReducer = (state, action) => {
  ...
  switch (type) {
    ...
    case BundleActionKind.SET_PAGINATED_BUNDLE_DATA:
      const {
        payload: paginatedBundleData
      } = action;
      return {
        ...state,
        data: (_state$data = state.data) === null || _state$data === void 0 ? void 0 : (_state$data$slice = _state$data.slice()) === null || _state$data$slice === void 0 ? void 0 : _state$data$slice.concat(paginatedBundleData),
        isNextPageLoading: false,
        error: null
      };
...
//# sourceMappingURL=bundleReducer.js.map