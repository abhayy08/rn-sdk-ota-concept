...
export declare enum UpdateMetaActionKind {
...
export type IUpdateMetaAction = ISetRunningUpdateMeta | ISetNewUpdateMeta | ISetInitProdSlot | ISetPendingReleaseHash;
export {};
//# sourceMappingURL=updateMeta.types.d.ts.map