...
export declare enum BucketActionKind {
...
export type IBucketAction = IBucketLoadingAction | IBucketDataAction | IBucketErrorAction;
export {};
//# sourceMappingURL=bucket.types.d.ts.map