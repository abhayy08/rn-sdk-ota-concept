...
export type IWithStallion = (BaseComponent: React.ComponentType, initPrams?: IStallionInitParams) => React.ComponentType;
...
export type TextChangeEventType = NativeSyntheticEvent<TextInputChangeEventData>;
