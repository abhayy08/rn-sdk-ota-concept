...
export declare enum DownloadActionKind {
...
export type IDownloadAction = IDownloadLoadingAction | IDownloadDataAction | IDownloadErrorAction;
export {};
//# sourceMappingURL=download.types.d.ts.map